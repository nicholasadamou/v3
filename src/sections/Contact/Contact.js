...
const Contact = () => (
	<section id="contact">
		<h2 className="title">Want to say "Hi" <span className="wave-emoji" role="img" aria-label="wave">👋🏼</span>?</h2>
		...
		<form action="https://formspree.io/nicholasadamouemail@gmail.com" method="POST">
